...
void SplittingFilter_Analysis(SplittingFilter* var, float* data, FrameBuffer* bands);
void SplittingFilter_Synthesis(SplittingFilter* var, FrameBuffer* bands, float* data);
